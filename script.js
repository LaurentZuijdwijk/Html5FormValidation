...
(function() {
  var HTML5Form, formFieldFactory,
  ...
  HTML5Form = (function() {
    ...
    HTML5Form.FormField = FormField = (function() {
      ...
      function FormField(element, form) {
        ...
        this.$element.addClass('pristine');
    ...
    HTML5Form.TextFormField = TextFormField = (function(_super) {
      ...
      TextFormField.prototype.focus = function(event) {
        this.$element.removeClass('pristine');
    ...
    HTML5Form.SelectFormField = SelectFormField = (function(_super) {
      ...
      SelectFormField.prototype.focus = function(event) {
        ...
        return this.$element.removeClass('pristine');
      };

      SelectFormField.prototype.blur = function(event) {};

      SelectFormField.prototype.change = function(event) {
        if (!this._validate()) {
          this.fieldErrorEvent();
          return this.$element.addClass('invalid');
        }
  ...
  $.fn.html5FormFieldValidator = function() {
    return this.each(function() {
      return formFieldFactory(this, $(this).closest("form"));
    });
  };
  ...
  $.fn.html5FormValidator = function() {
    ...
    return this.each(function() {
      ...
      checkInputFields = (function(_this) {
        return function() {
          errors = [];
          $form.find('textarea.invalid, select.invalid, input:not(:submit,:button,:image).invalid, textarea.pristine, select.pristine, input:not(:submit,:button,:image).pristine').each(function() {
            if ($(this).hasClass('pristine')) {
              if ($(this).attr('required')) {
                $(this).addClass('invalid');
                return errors.push(this);
              }
            } else {
              return errors.push(this);
            }
